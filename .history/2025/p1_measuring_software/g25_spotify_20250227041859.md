...
# Conclusion
There are few findings that can be concluded from this study. Firstly the effiecny of native desktops isn't always gureanteed over web apps on browsers such as chrome. This is clearly shown by the results of this study. Feature availibility and the presence of background jobs in desktop applications make a application like spotify which relies on these more inefficient in it
