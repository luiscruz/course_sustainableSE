...
_Figure 1: Violin and Box plots of energy consumption (J) without outliers._
...
_Figure 2: Violin and Box plots of energy consumption (J) with outliers._
...
_Table 1: Values reported by Shapiro-Wilk with and without outliers._

![Violin Plot](../img/p1_measuring_software/g25_spotify/box_no_outliers.png)
_Figure 3: Violin and Box plots of energy consumption (J) without outliers._
...
_Table 2: Effect size analysis._
...
The future work would involve considering all or most use cases. More specific cases such as comparing the native vs web app with different audio qualities. Another interesting case would be looks
